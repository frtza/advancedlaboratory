...
In this case, one assumes $N_0 \kern+0.5pt , N_2 \gg N_1 \kern+0.5pt , N_3$ for $N \approx N_0 + N_2$ and $\Delta N \approx N_2$ as well as
\begin{equation*}
	\pfrac{d\Delta N}{dt} \approx \rho B (N_0 + N_2) - AN_2 \approx \rho B N - A\Delta N \: ,
\end{equation*}
which yields
\begin{equation*}
	\Delta N_s = \pfrac{N}{\rho / \kern-0.5pt \rho_s} \: .
\end{equation*}
Accordingly, a population inversion $\Delta N_s > 0$ is achieved, making four level systems a suitable choice for laser construction.
