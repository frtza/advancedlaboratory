...
% append portable document files
\usepackage{pdfpages}
...
\newcommand{\cbg}[1]{\colorbox{olivedrab!50}{#1}}
\newcommand{\cbb}[1]{\colorbox{steelblue!50}{#1}}
\newcommand{\cbr}[1]{\colorbox{firebrick!50}{#1}}
\newcommand{\cby}[1]{\colorbox{goldenrod!50}{#1}}
...
\author{
	Fritz Ali Agildere\\ % Name
	\href{mailto:fritz.agildere@udo.edu}{fritz.agildere@udo.edu} % Email
	\and
	Jan Lucca Viola\\ % Name
	\href{mailto:janlucca.viola@udo.edu}{janlucca.viola@udo.edu} % Email
}
