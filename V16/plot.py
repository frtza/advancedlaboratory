...
# 
# # set locale
# plt.rc('text.latex', preamble=r'\sisetup{locale=US}')
# 
...
# plt.plot(a**2, 2*a**2, '-', color='olivedrab', label='Theory')
# plt.plot(a_2**2, c_2**2, 'kx', markersize=3.21, label='Measurement')
...
# with open('build/table_general.tex', 'w') as f:
...
# with open('build/table_specific.tex', 'w') as f:
# 	f.write(table_header)
