...
Dies lässt sich auch an der geringen Streuung des Mittelwerts $\input{build/Nmess.tex}$ verifizieren, welcher in etwa mit
der an der Apparatur gegebenen Pulsfrequenz von $\input{build/Ntheo.tex}$ übereinstimmt.
